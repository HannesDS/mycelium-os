    ...
    return (
      <div className="flex h-full bg-[#0a0a0f] items-center justify-center">
        <div className="max-w-md text-center">
          <h1 className="text-xl font-semibold text-white">Root setup</h1>
      ...
      {isMinimalConfig && (
        <div className="flex items-center justify-between border-b border-amber-500/20 bg-amber-500/5 px-6 py-3">
          <p className="text-sm text-amber-200">
            Setup mode: Configure your first shrooms. Chat with Root to add shrooms, set skills, and configure prompts.
          </p>
          <Link
            href="/constitution"
